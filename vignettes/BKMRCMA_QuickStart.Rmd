...
```{r CDERisk, warning=FALSE, message=FALSE, results='hide', out.width = "100%"} 
# CDE 
...
### Total Effect
```{r TEsingvar, warning=FALSE, message=FALSE, results='hide', out.width = "100%"}
...
```{r CDERisksingvar10, warning=FALSE, message=FALSE, results='hide', out.width = "100%"} 
